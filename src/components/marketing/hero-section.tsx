...
export function HeroSection() {
  return (
    ...
    >
      <div className="mx-auto grid w-full max-w-6xl gap-12 px-4 py-16 md:grid-cols-2 md:items-center md:px-6 md:py-24">
        <div className="flex flex-col items-start">
          ...
          <h1
            id="hero-heading"
            className="mt-6 text-pretty text-4xl font-semibold leading-[1.1] tracking-tight text-foreground md:text-5xl"
          >
          ...
          <ul className="mt-8 flex flex-col gap-2.5">
            {highlights.map((item) => (
              <li key={item} className="flex items-center gap-2.5 text-sm text-muted-foreground">
                <span className="flex size-5 items-center justify-center rounded-full bg-positive/10 text-positive">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-5 -left-5 hidden rounded-lg border border-border bg-card p-4 shadow-md sm:block">
            ...
            <p className="mt-1 text-2xl font-semibold text-foreground">1.480 €</p>
