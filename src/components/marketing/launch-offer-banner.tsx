  ...
  if (!offer.active) {
    return (
      <div className="border-b border-border bg-muted/50">
        <div className="mx-auto flex max-w-6xl items-center justify-center gap-2 px-4 py-2.5 text-center text-sm text-muted-foreground md:px-6">
          <span>
            {TRIAL_DAYS} días de prueba gratuita al registrarte · Sin permanencia
          </span>
    ...
    <div className="border-b border-solar/30 bg-solar/10">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-1 px-4 py-2.5 text-center text-sm md:flex-row md:gap-3 md:px-6">
        <p className="font-medium text-foreground">
          Oferta de lanzamiento: {offer.trialDays} días gratis + {offer.discountPercent}% dto. para los{" "}
          {offer.earlyBirdLimit} primeros
        </p>
